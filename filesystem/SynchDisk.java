...
public class SynchDisk implements VoidFunctionPtr {
	...
	/**
	 * Disk interrupt handler. Need this to be a C routine, because C++ can't handle
	 ...
	 * 
	 * @param pName
	 *            UNIX file name to be used as storage for the disk data (usually,
	 *            "DISK")
	 */
	...
	/**
	 * Read the contents of a disk sector into a buffer. Return only after the data
	 * has been read.
	 * 
	 * @param sectorNumber
	...
	/**
	 * Write the contents of a buffer into a disk sector. Return only after the data
	 * has been written.
	 * 
	 * @param sectorNumber
	...
	/**
	 * Disk interrupt handler. Wake up any thread waiting for the disk request to
	 * finish.
	 */
