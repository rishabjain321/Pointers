...
public class Semaphore {
	 ...
	 * decrementing must be done atomically, so we need to disable interrupts before
	 * checking the value.
	 * 
	 * Note that NachosProcess::sleep assumes that interrupts are disabled when it
	 * is called.
	 */
	public void P() {
		// disable interrupts
