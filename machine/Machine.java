...
public class Machine {
	...
	public static final int NumPhysPages = 16; // changed from 1024 to 32 for
	// testing
	...
	/**
	 * The hardware timer. This class can throw interrupts at scheduable intervals.
	 */
	...
	/**
	 * Read "size" (1, 2, or 4) bytes of virtual memory at "addr" into the location
	 * pointed to by "value".
	 * 
	 * Returns FALSE if the translation step from virtual to physical memory failed.
	 * 
	 * "addr" -- the virtual address to read from "size" -- the number of bytes to
	 * read (1, 2, or 4) "value" -- the place to write the result
	 */
	...
	public static void debugger() {
		 ...
		 * 
		 * fgets(buf, 80, stdin); if (sscanf(buf, "%d", &num) == 1) { runUntilTime =
		 * num; } else { runUntilTime = 0;
		 * 
		 * switch (*buf) { case '\n': break;
		 * 
