...
public class TranslationEntry {
	/* project 2 phase 3 */
	// add a new element to the entry, called trans_diskmap
	public int trans_diskmap;
	...
	/**
	 * If this bit is set, the translation is ignored. (In other words, the entry
	 * hasn't been initialized.)
	 */
	public boolean valid;

	/**
	 * If this bit is set, the user program is not allowed to modify the contents of
	 * the page.
	 */
